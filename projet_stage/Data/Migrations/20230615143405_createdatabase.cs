        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Emp_Function = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTaken = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Employees_Id_Employee",
                        column: x => x.Id_Employee,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assignments_Materials_Id_Material",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_Id_Employee",
                table: "Assignments",
                column: "Id_Employee");

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_Id_Material",
                table: "Assignments",
                column: "Id_Material");
        }
